...
function convertDataFormat(data,date) {
  const result = {
    ...
    "_billing_first_name": data.billingFirstName || "",
    "_billing_last_name": data.billingLastName || "",
    "_billing_country": data.billingCountry || "",
    "_billing_address_1": "", // No direct mapping in input data
    "_billing_address_2": data.billingApartment || "",
    "_billing_city": data.billingCity || "",
    "_billing_state": data.billingState || "",
    "_billing_postcode": data.billingZip || "",
    "_billing_phone": "", // No direct mapping in input data
    "_billing_company": "",
    "_billing_company_kvk": "",
    "_billing_company_vat": "",
    
    // Shipping information
    "_shipping_email": data.email || "",
    "_shipping_first_name": data.shippingFirstName || "",
    "_shipping_last_name": data.shippingLastName || "",
    "_shipping_country": data.shippingCountry || "",
    "_shipping_address_1": "", // No direct mapping in input data
    "_shipping_address_2": data.shippingApartment || "",
    "_shipping_city": data.shippingCity || "",
    "_shipping_state": data.shippingState || "",
    "_shipping_postcode": data.shippingZip || "",
    "_shipping_phone": "", // No direct mapping in input data
    "_shipping_company": "",
    ...
    // Other fields that remain as-is
  ...
  // Add transactionId if it exists
    ...
    result.transactionId = "Subscription Tx";
  
  
  // Add discountsData if it exists
  
    result.discountsData = {};
  
  
  // Add customer IP address if it exists
  
    result._customer_ip_address = "0.0.0.0";
  
  
  // Add payment method title if it exists

    result._payment_method_title = "Subscription points";
